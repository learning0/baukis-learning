...
ActiveRecord::Schema.define(version: 20150109130340) do
  ...
  add_index "allowed_sources", ["namespace", "octet1", "octet2", "octet3", "octet4"], name: "index_allowed_sources_on_namespace_and_octeds", unique: true, using: :btree
  ...
  add_index "entries", ["program_id"], name: "entries_program_id_fk", using: :btree
